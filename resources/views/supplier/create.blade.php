        ...
        <div class="card-body p-4 row justify-content-center bg-secondary">
            <div class="col-12">
                <div class="form-group @error('kd_supp') has-error has-feedback @enderror">
                    ...
                    <input name="kd_supp" value="{{ old('kd_supp') }}" type="text" class="form-control" placeholder="Kode Supplier">
                    @error('kd_supp') 
                ...
                <div class="form-group @error('telpon') has-error has-feedback @enderror">
                    <label>Telpon</label>
                    <input name="telpon" value="{{ old('telpon') }}" type="text" class="form-control" placeholder="Telpon">
                    @error('telpon') 
                    <small class="form-text text-danger">
                        <strong>{{ $message }}</strong>
                    </small> 
                ...
                <div class="form-group @error('alamat') has-error has-feedback @enderror">
                    <label>Alamat</label>
                    <input name="alamat" value="{{ old('alamat') }}" type="text" class="form-control" placeholder="Alamat">
                    @error('alamat') 
                    <small class="form-text text-danger">
                        <strong>{{ $message }}</strong>
                    </small> 
